print("Welcome to our hotel THE ROYAL PALM LEAF. A home away from home.")
print("Situated in tranquility of serene nature.7 Kilometers from air port")
print("and 5 Kilometers from the Railway station. A beautiful place to unwind")
print("with all modern facilities like swiming pool, Wifi, gym, and a multi")
print("cuisine restaurent with 24 hours running coffee bar.")
print("A 5 star property of the PALM LEAF group. We have a special areas")
print("for kids where they can find variety of video games and out door games too.")
print("The view of the whole city can be seen from the common terrace.")
print("our staff will help you when so ever needed." "\n")
